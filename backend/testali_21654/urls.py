"""testali_21654 URL Configuration
...
admin.site.site_header = "Testali"
admin.site.site_title = "Testali Admin Portal"
admin.site.index_title = "Testali Admin"

# swagger
api_info = openapi.Info(
    title="Testali API",
    default_version="v1",
    description="API documentation for Testali App",
)
